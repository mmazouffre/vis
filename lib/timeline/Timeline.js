...
function Timeline (container, items, groups, options) {
  ...
  // subitem set
  this.subItemSet = new SubItemSet(this.body, this.options);
  this.components.push(this.subItemSet);
...
/**
 * Set subitems
 * @param {vis.DataSet | Array | null} subitems
 */
Timeline.prototype.setSubItems = function(subItems) {
  // convert to type DataSet when needed
  var newDataSet;
  if (!subItems) {
    newDataSet = null;
  }
  else if (subItems instanceof DataSet || subItems instanceof DataView) {
    newDataSet = subItems;
  }
  else {
    // turn an array into a dataset
    newDataSet = new DataSet(subItems, {
      type: {
        item: 'Item'
        start: 'Date',
        end: 'Date'
  ...
  // set subitems
  this.subItemsData = newDataSet;
  this.subItemSet && this.subItemSet.setSubItems(newDataSet);
};
