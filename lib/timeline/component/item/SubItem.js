 ...
 *                                  start, end, content, item, className.
 * @param {{toScreen: function, toTime: function}} conversion
 *                                  Conversion functions from time to screen and vice versa
 * @param {Object} options          Configuration options
 *                                  // TODO: describe available options
 */
function SubItem (data, conversion, options) {
  this.id = null;
  this.parent = null;
  this.data = data;
  this.dom = null;
...
SubItem.prototype.stack = true;

/**
 * Select current item
 */
SubItem.prototype.select = function() {
  this.selected = true;
  this.dirty = true;
 ...
 */
SubItem.prototype.unselect = function() {
  this.selected = false;
  this.dirty = true;
  if (this.displayed) this.redraw();
};
 ...
 * @param {Group} parent
 */
SubItem.prototype.setParent = function(parent) {
  if (this.displayed) {
    this.hide();
    this.parent = parent;
    if (this.parent) {
 ...
 */
SubItem.prototype.isVisible = function(range) {  // eslint-disable-line no-unused-vars
  return false;
};
 ...
 * Repaint the item
 */
SubItem.prototype.redraw = function() {
 ...
 */
SubItem.prototype.repositionX = function() {
  // should be implemented by the item
};
 ...
 */
SubItem.prototype.repositionY = function() {
  // should be implemented by the item
};
 ...
 * @protected
 */
SubItem.prototype._repaintDragCenter = function () {
 ...
 * @protected
 */
SubItem.prototype._repaintDeleteButton = function (anchor) {
 ...
 * @protected
 */
SubItem.prototype._repaintOnItemUpdateTimeTooltip = function (anchor) {
 ...
 * @private
 */
SubItem.prototype._updateContents = function (element) {
  var content;
  var changed;
  var templateFunction;
 ...
 * @private
 */
SubItem.prototype._updateDataAttributes = function(element) {
 ...
 * @private
 */
SubItem.prototype._updateStyle = function(element) {
  // remove old styles
  if (this.style) {
 ...
 * @private
 */
SubItem.prototype._contentToString = function (content) {
 ...
 */
SubItem.prototype._updateEditStatus = function() {
  if (this.options) {
 ...
 * @return {number}
 */
SubItem.prototype.getWidthLeft = function () {
  return 0;
};
 ...
 * @return {number}
 */
SubItem.prototype.getWidthRight = function () {
  return 0;
};
 ...
 */
SubItem.prototype.getTitle = function () {
